...
// function filterCategory(category,cardsAll){
...
itemsContainer.addEventListener("click", cardInfo);

let background = document.querySelector(".card-info-background");

let containerCardInfo = document.querySelector(".container-card-info");


function cardInfo(){
    
    if(background.style.display !== "block" && containerCardInfo.style.display !== "flex"){
       
        background.style.display = "block";
        containerCardInfo.style.display = "flex";
       }
...
function backgroundClose(){
    if(background.style.display !== "none" && containerCardInfo.style.display !== "none"){
       
        background.style.display = "none";
        containerCardInfo.style.display = "none";   
       }
    }
